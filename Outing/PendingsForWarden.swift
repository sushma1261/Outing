//
//  PendingsForWarden.swift
//  Outing
//
//  Created by SVECW-4 on 30/09/18.
...
class PendingsForWarden: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    func getDetails() {
        ...
        ref.child("pending").observeSingleEvent(of: DataEventType.value, with: { snapshot in
            var i:Int = 0
            //print(snapshot)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = table1.dequeueReusableCell(withIdentifier: "cellWarPen", for: indexPath) as? CustomCellPenWar
